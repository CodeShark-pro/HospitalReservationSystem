...
SECRET_KEY = 'django-insecure-c4+(vrw6msufz-xc4z%*e*jdy49d=czp=%bnv2381bqnm)s!^l'
...
STATIC_URL = '/static/'  # Always end the URL with a slash

# Development static files directory
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'hospital', 'static'),  # This is your existing configuration
]
